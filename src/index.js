...
const aggregatorV3Addr = "0x9326BFA02ADD2366b30bacB125260Af641031331"
const priceFeedInst = new web3.eth.Contract(aggregatorV3InterfaceABI, aggregatorV3Addr)
const base_price = 1
...
const do_rebase = async (latest_price, base_price) => {
  //contract or expand the token supply
...
// test do_rebase with arbitrary data
do_rebase(1.04, 1)
...
setInterval(async () => {
  ...
  const roundData = await priceFeedInst.methods.latestRoundData().call()
